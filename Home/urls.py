...
from .import views
from .views import SampleViewerView, SampleUploderView, SampleDetailView, SampleEditorView, DeleteSampleView
urlpatterns = [
    ...
    path('deletesample/<int:pk>/delete',
         DeleteSampleView.as_view(), name='deletesample'),
